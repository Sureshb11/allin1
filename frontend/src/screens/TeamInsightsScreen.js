...
const makeStyles = (DS) => StyleSheet.create({
  ...
  ratioText: { fontSize: 11, color: DS.white, fontWeight: '700' },
  ...
  formChipText: { fontSize: 12, fontWeight: '700', color: DS.white },
  ...
  rankNumText: { fontSize: 11, color: DS.white, fontWeight: '800' },
