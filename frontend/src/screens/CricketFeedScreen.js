// CricketFeedScreen — the cricket landing page.
...
function Avatar({ initial, color, size = 40, ring = false }) {
  return (
    <View style={[
...
function CommentsSheet({ post, onClose, onAdd }) {
...
// ── Screen ──────────────────────────────────────────────────────────────────
export default function CricketFeedScreen({ navigation }) {
